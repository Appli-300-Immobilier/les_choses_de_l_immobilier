...
<li>- 0703313371</li>
            <li>Email: contact@leschosesdelimmobilier.cm</li>
            
            
            <li className="flex items-center gap-4 pt-2">
              <a href="https://www.facebook.com/profile.php?id=100064888095656" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-600 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="Facebook">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://wa.me/2250798705131" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-500 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="WhatsApp">
